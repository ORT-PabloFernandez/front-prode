...
export default function PartidoPageId() {
    ...
    // TOMO 2 LETRAS PARA EL CODIGO GRANDE Y 3 PARA EL CODIGO CHICO DEBAJO DEL NOMBRE
    ...
    return (
        <main className="min-h-screen bg-slate-900 px-4 py-10 text-white flex flex-col items-center gap-6">
            ...
            {/* CARD DE PRONOSTICO - MOCKUP SIN LOGICA, LA LOGICA PENDIENTE */}
            <article
            ...
            >
                ...
                <div className="flex items-center justify-around gap-4">
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            <button style={{ borderColor: "#ffffff33" }} className="w-10 h-10 rounded-xl border text-lg font-bold text-white bg-transparent">−</button>
                            <span style={{ color }} className="text-4xl font-black w-10 text-center">0</span>
                            <button style={{ borderColor: "#ffffff33" }} className="w-10 h-10 rounded-xl border text-lg font-bold text-white bg-transparent">+</button>
                        </div>
                    </div>
                ...
                <button
                    ...
                    className="mt-8 w-full py-3 rounded-2xl font-bold text-sm uppercase tracking-widest text-white"
                >
