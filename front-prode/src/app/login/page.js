    ...
    <main className="min-h-screen bg-slate-900 flex items-center justify-center px-4 py-10 text-white">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#212542] rounded-3xl px-8 py-10 shadow-lg">
          ...
          <p className="text-slate-400 text-sm text-center mb-8">Entrá para cargar tus pronósticos</p>
          ...
          <p className="text-slate-400 text-sm text-center mt-6">
            ¿No tenés cuenta?{" "}
            <Link href="/registro" className="text-[#9d8bff] font-bold hover:underline">
              Registrate
            </Link>
          </p>
        </div>
